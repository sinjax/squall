 ...
 *
 */
public abstract class NumericValueFunction extends BaseValueFunction {
	 ...
	 */
	public NumericValueFunction(Node[] ns, Node_Variable rn, Map<Node, BaseValueFunction> funcs)
			throws RIFPredicateException {
		super(ns, rn, funcs);
	}
