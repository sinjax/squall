...
public class TripleFilterFunction extends BaseFilterFunction {
...
//		logger.debug(String.format("Testing at Filter(%s): %s", this.clause, inc));
	 ...
	 *
	 */
	public static class RuleWrappedTripleFilter extends RuleWrappedFunction<TripleFilterFunction> {
